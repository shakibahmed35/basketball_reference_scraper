...
team1_basic_stats_table = table_generate(basic1_rows[2:])
...
team1_advanced_stats_table = table_generate(advanced1_rows[2:])
...
t1_advanced_df.drop(columns=['Player', 'MP'], inplace=True)
...
team2_basic_stats_table = table_generate(basic2_rows[2:])
...
team2_advanced_stats_table = table_generate(advanced2_rows[2:])
...
t2_advanced_df.drop(columns=['Player', 'MP'], inplace=True)
